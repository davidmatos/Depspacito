...
public class ServerConfidentialityLayer extends DepSpaceServerLayer {
	 ...
	 * 
	 * @param upperLayer
	 *            The upper layer (Policy Enforcement or Tuple Space layer)
	 * @param scheme
	 *            TODO comment
	 * @param conf
	 *            The configuration
	...
	// private DepTuple checkRemove(DepSpaceReply[] msgs, ProtectionVector
	// protectionVector) {
	...
	// for(ListIterator<DepTuple> li = candidateShares.listIterator();
	// li.hasNext(); ) {
	...
	// for(ListIterator<DepTuple> li = validCandidateShares.listIterator();
	// li.hasNext(); ) {
	...
	//
	//
	// private final List<DepTuple> extractCandidateResponse(DepSpaceReply[]
	// msgs) {
